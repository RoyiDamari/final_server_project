...
def render_rf_params_ui(
    ...
    """
    Render UI controls for Random Forest parameters and return an updated params dict.

    Calls ask_btn(...) next to each parameter for contextual explanations.
